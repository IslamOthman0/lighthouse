...
const BreakCard = ({ member, theme, onClick, workingDays = 1 }) => {
  ...
  // Get timer gradient for break status
  const timerStyle = {
    background: `linear-gradient(135deg, ${theme.breakLight} 0%, ${theme.break} 50%, ${theme.breakDark} 100%)`,
    backgroundClip: 'text',
    WebkitBackgroundClip: 'text',
    WebkitTextFillColor: 'transparent',
    MozBackgroundClip: 'text',
    MozTextFillColor: 'transparent',
    filter: `drop-shadow(0 0 15px ${theme.breakGlow})`,
    ...
    >
      ...
      <div className="m-4 p-4 rounded-xl border border-white/[0.08]" style={{ background: theme.innerBg }}>
        ...
        <div
          ...
          style={{ background: theme.subtleBg, borderColor: theme.borderLight }}
        >
